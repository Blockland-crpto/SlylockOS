#
sources=$(find ./libs/libdmgctrl/* -type f -name "*.c")
...
ta=$(echo ./libdmgctrlbin/$(basename $(echo $objects | cut -d" " -f$i )))
...
cppsources=$(find ./libs/libdmgctrl/* -type f -name "*.cpp")
...
tap=$(echo ./libdmgctrlbin/$(basename $(echo $cppobjects | cut -d" " -f$i )))
...
ar rcs lib/libdmgctrl.a libdmgctrlbin/*.o
