#
sources=$(find ./libs/libpic/* -type f -name "*.c")
...
ta=$(echo ./libpicbin/$(basename $(echo $objects | cut -d" " -f$i )))
...
cppsources=$(find ./libs/libpic/* -type f -name "*.cpp")
...
tap=$(echo ./libpicbin/$(basename $(echo $cppobjects | cut -d" " -f$i )))
...
ar rcs lib/libpic.a libpicbin/*.o
