...
ta=$(echo ./libmousebin/$(basename $(echo $objects | cut -d" " -f$i )))
...
cppsources=$(find ./libs/libmouse/* -type f -name "*.cpp")
...
tap=$(echo ./libmousebin/$(basename $(echo $cppobjects | cut -d" " -f$i )))
...
ar rcs lib/libmouse.a libmousebin/*.o
