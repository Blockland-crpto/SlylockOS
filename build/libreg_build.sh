#
sources=$(find ./libs/libreg/* -type f -name "*.c")
...
ta=$(echo ./libregbin/$(basename $(echo $objects | cut -d" " -f$i )))
...
cppsources=$(find ./libs/libreg/* -type f -name "*.cpp")
...
tap=$(echo ./libregbin/$(basename $(echo $cppobjects | cut -d" " -f$i )))
...
ar rcs lib/libreg.a libregbin/*.o
