#
sources=$(find ./libs/libnmi/* -type f -name "*.c")
...
ta=$(echo ./libnmibin/$(basename $(echo $objects | cut -d" " -f$i )))
...
cppsources=$(find ./libs/libnmi/* -type f -name "*.cpp")
...
tap=$(echo ./libnmibin/$(basename $(echo $cppobjects | cut -d" " -f$i )))
...
ar rcs lib/libnmi.a libnmibin/*.o
