#
sources=$(find ./libs/libexe/* -type f -name "*.c")
...
ta=$(echo ./libexebin/$(basename $(echo $objects | cut -d" " -f$i )))
...
cppsources=$(find ./libs/libexe/* -type f -name "*.cpp")
...
tap=$(echo ./libexebin/$(basename $(echo $cppobjects | cut -d" " -f$i )))
...
ar rcs lib/libexe.a libexebin/*.o
