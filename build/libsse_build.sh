#
sources=$(find ./libs/libsse/* -type f -name "*.c")
...
ta=$(echo ./libssebin/$(basename $(echo $objects | cut -d" " -f$i )))
...
cppsources=$(find ./libs/libsse/* -type f -name "*.cpp")
...
tap=$(echo ./libssebin/$(basename $(echo $cppobjects | cut -d" " -f$i )))
...
ar rcs lib/libsse.a libssebin/*.o
