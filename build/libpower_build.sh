#
sources=$(find ./libs/libpower/* -type f -name "*.c")
...
ta=$(echo ./libpowerbin/$(basename $(echo $objects | cut -d" " -f$i )))
...
cppsources=$(find ./libs/libpower/* -type f -name "*.cpp")
...
tap=$(echo ./libpowerbin/$(basename $(echo $cppobjects | cut -d" " -f$i )))
...
ar rcs lib/libpower.a libpowerbin/*.o
