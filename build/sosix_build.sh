...
objb="${objb} ${ta}"
gcc -m32 -elf_i386 -Wall -O -fstrength-reduce -fomit-frame-pointer -finline-functions -nostdinc -fno-builtin  -fstack-protector-all -I./include/kernel -I./include/sosix -c -o $ta $tb
done
