...
void shift_rows(uint8_t* state) {
	...
	// Rotate second row by one position to the left
	temp = state[1];
	state[1] = state[5];
	state[5] = state[9];
	state[9] = state[13];
	...
	// Rotate third row by two positions to the left
	temp = state[2];
	state[2] = state[10];
	state[10] = temp;
	temp = state[6];
	...
	// Rotate fourth row by three positions to the left
	temp = state[15];
	state[15] = state[11];
	state[11] = state[7];
	state[7] = state[3];
...
void aes_encrypt(const uint8_t* plaintext, const uint8_t* key, uint8_t* ciphertext) {
	...
	sub_bytes(state);
	shift_rows(state);
	add_round_key(state, round_keys + 10 * AES_BLOCK_SIZE);

	// Copy the final state as the ciphertext
...
void inv_shift_rows(uint8_t *state) {
	...
	// Rotate second row by one position to the right
	temp = state[13];
	state[13] = state[9];
	state[9] = state[5];
	state[5] = state[1];
	...
	// Rotate third row by two positions to the right
	temp = state[2];
	state[2] = state[10];
	state[10] = temp;
	temp = state[6];
	...
	// Rotate fourth row by three positions to the right
	temp = state[3];
	state[3] = state[7];
	state[7] = state[11];
	state[11] = state[15];
